...
const Hero = () => {
  return (
    <div className="w-full h-[580px] bg-sky-950">
        <div className="grid grid-cols-2 h-full content-center">
            <div className="flex flex-col pl-32 space-y-2">
                ...
                <p className="font-light text-sm">Mengembangkan potensi mahasiswa Teknik Informatikadengan berlandaskan Tri Dharma Perguruan Tinggi</p>
            </div>
